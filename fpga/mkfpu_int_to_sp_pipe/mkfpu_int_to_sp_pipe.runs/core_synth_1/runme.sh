...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_int_to_sp_pipe/mkfpu_int_to_sp_pipe.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_int_to_sp_pipe.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_int_to_sp_pipe.tcl
