...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_convert_sp_dp_single/mkfpu_convert_sp_dp_single.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source FIFO2.tcl
