...
HD_PWD='/scratch/git_repo/c-class/fpga/c-class/c-class.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkstage2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkstage2.tcl
