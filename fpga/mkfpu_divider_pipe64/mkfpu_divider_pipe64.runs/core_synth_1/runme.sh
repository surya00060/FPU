...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_divider_pipe64/mkfpu_divider_pipe64.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_divider_pipe64.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_divider_pipe64.tcl
