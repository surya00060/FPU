...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_int_to_dp/mkfpu_int_to_dp.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_int_to_dp.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_int_to_dp.tcl
