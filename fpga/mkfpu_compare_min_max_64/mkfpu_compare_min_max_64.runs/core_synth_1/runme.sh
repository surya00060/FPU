...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_compare_min_max_64/mkfpu_compare_min_max_64.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_compare_min_max_64.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_compare_min_max_64.tcl
