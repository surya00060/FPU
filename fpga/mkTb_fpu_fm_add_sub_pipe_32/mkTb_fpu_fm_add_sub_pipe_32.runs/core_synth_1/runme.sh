...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkTb_fpu_fm_add_sub_pipe_32/mkTb_fpu_fm_add_sub_pipe_32.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_fm_add_sub_pipe_32.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_fm_add_sub_pipe_32.tcl
