...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_fm_add_sub_pipe_64/mkfpu_fm_add_sub_pipe_64.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_fm_add_sub_pipe_64.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_fm_add_sub_pipe_64.tcl
