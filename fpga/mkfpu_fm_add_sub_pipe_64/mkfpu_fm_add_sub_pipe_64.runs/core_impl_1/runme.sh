...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_fm_add_sub_pipe_64/mkfpu_fm_add_sub_pipe_64.runs/core_impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_fm_add_sub_pipe_64.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mkfpu_fm_add_sub_pipe_64.tcl -notrace
