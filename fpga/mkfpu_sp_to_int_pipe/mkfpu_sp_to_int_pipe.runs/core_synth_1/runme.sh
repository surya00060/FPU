...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_sp_to_int_pipe/mkfpu_sp_to_int_pipe.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_sp_to_int_pipe.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_sp_to_int_pipe.tcl
