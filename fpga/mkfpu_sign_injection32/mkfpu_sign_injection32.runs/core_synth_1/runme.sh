...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_sign_injection32/mkfpu_sign_injection32.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_sign_injection32.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_sign_injection32.tcl
