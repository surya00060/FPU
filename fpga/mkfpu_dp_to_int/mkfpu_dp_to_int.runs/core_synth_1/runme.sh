...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_dp_to_int/mkfpu_dp_to_int.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_dp_to_int.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_dp_to_int.tcl
