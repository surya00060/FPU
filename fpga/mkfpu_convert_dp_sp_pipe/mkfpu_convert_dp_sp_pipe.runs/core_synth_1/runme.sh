...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkfpu_convert_dp_sp_pipe/mkfpu_convert_dp_sp_pipe.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkfpu_convert_dp_sp_pipe.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkfpu_convert_dp_sp_pipe.tcl
