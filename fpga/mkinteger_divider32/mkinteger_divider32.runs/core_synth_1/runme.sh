...
HD_PWD='/home/surya/Desktop/FPU/fpga/mkinteger_divider32/mkinteger_divider32.runs/core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mkinteger_divider32.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mkinteger_divider32.tcl
