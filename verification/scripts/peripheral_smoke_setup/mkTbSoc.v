...
//
// On Thu Jul  5 10:55:47 IST 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkTbSoc(CLK,
  ...
  wire flash0$CSNeg, flash0$SCK;

  // ports of submodule flash1
  wire flash1$CSNeg, flash1$SCK;

  // ports of submodule i2c_bfm_slave0
  wire i2c_bfm_slave0$A0,
       i2c_bfm_slave0$A1,
       i2c_bfm_slave0$A2,
       i2c_bfm_slave0$SCL,
       i2c_bfm_slave0$WP;

  // ports of submodule i2c_bfm_slave1
  wire i2c_bfm_slave1$A0,
       i2c_bfm_slave1$A1,
       i2c_bfm_slave1$A2,
       i2c_bfm_slave1$SCL,
       i2c_bfm_slave1$WP;

  // ports of submodule line_SCL0
  tri1 line_SCL0$IO; wire line_SCL0$O;
  //wire line_SCL0$IO, line_SCL0$O;

  // ports of submodule line_SCL1
  tri1 line_SCL1$IO; wire line_SCL1$O;
  //wire line_SCL1$IO, line_SCL1$O;

  // ports of submodule line_SDA0
  tri1 line_SDA0$IO; wire line_SDA0$O;
  //wire line_SDA0$IO, line_SDA0$O;

  // ports of submodule line_SDA1
  tri1 line_SDA1$IO; wire line_SDA1$O;
  //wire line_SDA1$IO, line_SDA1$O;

  // ports of submodule linescl0
  wire linescl0$O;

  // ports of submodule linescl1
  wire linescl1$O;

  // ports of submodule qspi0tri_sio0
  wire qspi0tri_sio0$IO, qspi0tri_sio0$O;

  // ports of submodule qspi0tri_sio1
  wire qspi0tri_sio1$IO, qspi0tri_sio1$O;

  // ports of submodule qspi0tri_sio2
  wire qspi0tri_sio2$IO, qspi0tri_sio2$O;

  // ports of submodule qspi0tri_sio3
  wire qspi0tri_sio3$IO, qspi0tri_sio3$O;

  // ports of submodule qspi1tri_sio0
  wire qspi1tri_sio0$IO, qspi1tri_sio0$O;

  // ports of submodule qspi1tri_sio1
  wire qspi1tri_sio1$IO, qspi1tri_sio1$O;

  // ports of submodule qspi1tri_sio2
  wire qspi1tri_sio2$IO, qspi1tri_sio2$O;

  // ports of submodule qspi1tri_sio3
  wire qspi1tri_sio3$IO, qspi1tri_sio3$O;
  ...
  wire [3 : 0] soc$slow_ios_qspi0_out_io_enable,
	       soc$slow_ios_qspi0_out_io_i_io_i,
	       soc$slow_ios_qspi0_out_io_o,
	       soc$slow_ios_qspi1_out_io_enable,
	       soc$slow_ios_qspi1_out_io_i_io_i,
	       soc$slow_ios_qspi1_out_io_o;
  wire soc$boot_sequence_bootseq,
       soc$slow_ios_i2c0_out_scl_in_in,
       soc$slow_ios_i2c0_out_scl_out,
       soc$slow_ios_i2c0_out_scl_out_en,
       soc$slow_ios_i2c0_out_sda_in_in,
       soc$slow_ios_i2c0_out_sda_out,
       soc$slow_ios_i2c0_out_sda_out_en,
       soc$slow_ios_i2c1_out_scl_in_in,
       soc$slow_ios_i2c1_out_scl_out,
       soc$slow_ios_i2c1_out_scl_out_en,
       soc$slow_ios_i2c1_out_sda_in_in,
       soc$slow_ios_i2c1_out_sda_out,
       soc$slow_ios_i2c1_out_sda_out_en,
       soc$slow_ios_qspi0_out_clk_o,
       soc$slow_ios_qspi0_out_ncs_o,
       soc$slow_ios_qspi1_out_clk_o,
       soc$slow_ios_qspi1_out_ncs_o,
       ...
       soc$slow_ios_uart0_coe_modem_output_stx,
  ...
  wire CAN_FIRE_RL_connect_boot,
       CAN_FIRE_RL_connect_flash0_input_ports,
       CAN_FIRE_RL_connect_flash0_ports1,
       CAN_FIRE_RL_connect_flash1_input_ports,
       CAN_FIRE_RL_connect_flash1_ports1,
       CAN_FIRE_RL_connect_gpio,
       CAN_FIRE_RL_connect_i2c0,
       CAN_FIRE_RL_connect_i2c1,
       CAN_FIRE_RL_connect_sin,
       CAN_FIRE_RL_connect_uart0_sin,
       CAN_FIRE_RL_connect_uart0_sout,
       CAN_FIRE_RL_increment_counter,
       CAN_FIRE_RL_open_file,
       CAN_FIRE_RL_send_sda_connect_i2c0,
       CAN_FIRE_RL_send_sda_connect_i2c1,
       ...
       WILL_FIRE_RL_connect_flash0_input_ports,
       WILL_FIRE_RL_connect_flash0_ports1,
       WILL_FIRE_RL_connect_flash1_input_ports,
       WILL_FIRE_RL_connect_flash1_ports1,
       WILL_FIRE_RL_connect_gpio,
       WILL_FIRE_RL_connect_i2c0,
       WILL_FIRE_RL_connect_i2c1,
       WILL_FIRE_RL_connect_sin,
       WILL_FIRE_RL_connect_uart0_sin,
       WILL_FIRE_RL_connect_uart0_sout,
       WILL_FIRE_RL_increment_counter,
       WILL_FIRE_RL_open_file,
       WILL_FIRE_RL_send_sda_connect_i2c0,
       WILL_FIRE_RL_send_sda_connect_i2c1,
  ...
  reg [31 : 0] TASK_fopen___d178;
  wire [3 : 0] x__h10010, x__h11651, x__h13442, x__h13468;
  wire _dor2uart_pwXmitCellCountReset$EN_wset,
       uart_baudGen_rBaudCounter_value__3_PLUS_1_0_ULT_5___d51,
       z__h14856,
       z__h14863,
       z__h14870,
       z__h14877,
  ...
  // submodule flash0
  CypressFlashWrapper flash0(.clk(slow_clock$CLK_OUT),
			     .rst(slow_reset$OUT_RST),
			     .CSNeg(flash0$CSNeg),
			     .SCK(flash0$SCK),
			     .SI(qspi0tri_sio0$IO),
			     .SO(qspi0tri_sio1$IO),
			     .WPNeg(qspi0tri_sio2$IO),
			     .RESETNeg(qspi0tri_sio3$IO));

  // submodule flash1
  CypressFlashWrapper flash1(.clk(slow_clock$CLK_OUT),
			     .rst(slow_reset$OUT_RST),
			     .CSNeg(flash1$CSNeg),
			     .SCK(flash1$SCK),
			     .SI(qspi1tri_sio0$IO),
			     .SO(qspi1tri_sio1$IO),
			     .WPNeg(qspi1tri_sio2$IO),
			     .RESETNeg(qspi1tri_sio3$IO));

  // submodule i2c_bfm_slave0
  M24AA1025 i2c_bfm_slave0(.RESET(slow_reset$OUT_RST),
			   .A0(i2c_bfm_slave0$A0),
			   .A1(i2c_bfm_slave0$A1),
			   .A2(i2c_bfm_slave0$A2),
			   .SCL(i2c_bfm_slave0$SCL),
			   .WP(i2c_bfm_slave0$WP),
			   .SDA(line_SDA0$IO));

  // submodule i2c_bfm_slave1
  M24AA1025 i2c_bfm_slave1(.RESET(slow_reset$OUT_RST),
			   .A0(i2c_bfm_slave1$A0),
			   .A1(i2c_bfm_slave1$A1),
			   .A2(i2c_bfm_slave1$A2),
			   .SCL(i2c_bfm_slave1$SCL),
			   .WP(i2c_bfm_slave1$WP),
			   .SDA(line_SDA1$IO));

  // submodule line_SCL0
  TriState #(.width(32'd1)) line_SCL0(.I(soc$slow_ios_i2c0_out_scl_out),
				      .OE(soc$slow_ios_i2c0_out_scl_out_en),
				      .O(line_SCL0$O),
				      .IO(line_SCL0$IO));

  // submodule line_SCL1
  TriState #(.width(32'd1)) line_SCL1(.I(soc$slow_ios_i2c1_out_scl_out),
				      .OE(soc$slow_ios_i2c1_out_scl_out_en),
				      .O(line_SCL1$O),
				      .IO(line_SCL1$IO));

  // submodule line_SDA0
  TriState #(.width(32'd1)) line_SDA0(.I(soc$slow_ios_i2c0_out_sda_out),
				      .OE(soc$slow_ios_i2c0_out_sda_out_en),
				      .O(line_SDA0$O),
				      .IO(line_SDA0$IO));

  // submodule line_SDA1
  TriState #(.width(32'd1)) line_SDA1(.I(soc$slow_ios_i2c1_out_sda_out),
				      .OE(soc$slow_ios_i2c1_out_sda_out_en),
				      .O(line_SDA1$O),
				      .IO(line_SDA1$IO));

  // submodule linescl0
  TriState #(.width(32'd1)) linescl0(.I(1'b1),
				     .OE(1'd0),
				     .O(linescl0$O),
				     .IO(line_SCL0$IO));

  // submodule linescl1
  TriState #(.width(32'd1)) linescl1(.I(1'b1),
				     .OE(1'd0),
				     .O(linescl1$O),
				     .IO(line_SCL1$IO));

  // submodule qspi0tri_sio0
  TriState #(.width(32'd1)) qspi0tri_sio0(.I(soc$slow_ios_qspi0_out_io_o[0]),
					  .OE(soc$slow_ios_qspi0_out_io_enable[0]),
					  .O(qspi0tri_sio0$O),
					  .IO(qspi0tri_sio0$IO));

  // submodule qspi0tri_sio1
  TriState #(.width(32'd1)) qspi0tri_sio1(.I(soc$slow_ios_qspi0_out_io_o[1]),
					  .OE(soc$slow_ios_qspi0_out_io_enable[1]),
					  .O(qspi0tri_sio1$O),
					  .IO(qspi0tri_sio1$IO));

  // submodule qspi0tri_sio2
  TriState #(.width(32'd1)) qspi0tri_sio2(.I(soc$slow_ios_qspi0_out_io_o[2]),
					  .OE(soc$slow_ios_qspi0_out_io_enable[2]),
					  .O(qspi0tri_sio2$O),
					  .IO(qspi0tri_sio2$IO));

  // submodule qspi0tri_sio3
  TriState #(.width(32'd1)) qspi0tri_sio3(.I(soc$slow_ios_qspi0_out_io_o[3]),
					  .OE(soc$slow_ios_qspi0_out_io_enable[3]),
					  .O(qspi0tri_sio3$O),
					  .IO(qspi0tri_sio3$IO));

  // submodule qspi1tri_sio0
  TriState #(.width(32'd1)) qspi1tri_sio0(.I(soc$slow_ios_qspi1_out_io_o[0]),
					  .OE(soc$slow_ios_qspi1_out_io_enable[0]),
					  .O(qspi1tri_sio0$O),
					  .IO(qspi1tri_sio0$IO));

  // submodule qspi1tri_sio1
  TriState #(.width(32'd1)) qspi1tri_sio1(.I(soc$slow_ios_qspi1_out_io_o[1]),
					  .OE(soc$slow_ios_qspi1_out_io_enable[1]),
					  .O(qspi1tri_sio1$O),
					  .IO(qspi1tri_sio1$IO));

  // submodule qspi1tri_sio2
  TriState #(.width(32'd1)) qspi1tri_sio2(.I(soc$slow_ios_qspi1_out_io_o[2]),
					  .OE(soc$slow_ios_qspi1_out_io_enable[2]),
					  .O(qspi1tri_sio2$O),
					  .IO(qspi1tri_sio2$IO));

  // submodule qspi1tri_sio3
  TriState #(.width(32'd1)) qspi1tri_sio3(.I(soc$slow_ios_qspi1_out_io_o[3]),
					  .OE(soc$slow_ios_qspi1_out_io_enable[3]),
					  .O(qspi1tri_sio3$O),
					  .IO(qspi1tri_sio3$IO));
  ...
  mkSoc soc(.reset_vector(39'h0000001000),
	    ...
	    .slow_ios_i2c0_out_scl_in_in(soc$slow_ios_i2c0_out_scl_in_in),
	    .slow_ios_i2c0_out_sda_in_in(soc$slow_ios_i2c0_out_sda_in_in),
	    .slow_ios_i2c1_out_scl_in_in(soc$slow_ios_i2c1_out_scl_in_in),
	    .slow_ios_i2c1_out_sda_in_in(soc$slow_ios_i2c1_out_sda_in_in),
	    .slow_ios_qspi0_out_io_i_io_i(soc$slow_ios_qspi0_out_io_i_io_i),
	    .slow_ios_qspi1_out_io_i_io_i(soc$slow_ios_qspi1_out_io_i_io_i),
	    ...
	    .slow_ios_uart0_coe_modem_output_stx(soc$slow_ios_uart0_coe_modem_output_stx),
	    .slow_ios_uart0_coe_modem_output_rts(),
	    .slow_ios_uart0_coe_modem_output_dtr(),
	    .slow_ios_uart1_coe_SOUT(),
	    .slow_ios_gpio_out(),
	    .slow_ios_gpio_out_en(),
	    .slow_ios_i2c0_out_scl_out(soc$slow_ios_i2c0_out_scl_out),
	    .slow_ios_i2c0_out_i2c_DRV0(),
	    .slow_ios_i2c0_out_i2c_DRV1(),
	    .slow_ios_i2c0_out_i2c_DRV2(),
	    .slow_ios_i2c0_out_i2c_PD(),
	    .slow_ios_i2c0_out_i2c_PPEN(),
	    .slow_ios_i2c0_out_i2c_PRG_SLEW(),
	    .slow_ios_i2c0_out_i2c_PUQ(),
	    .slow_ios_i2c0_out_i2c_PWRUPZHL(),
	    .slow_ios_i2c0_out_i2c_PWRUP_PULL_EN(),
	    .slow_ios_i2c0_out_scl_out_en(soc$slow_ios_i2c0_out_scl_out_en),
	    .slow_ios_i2c0_out_sda_out(soc$slow_ios_i2c0_out_sda_out),
	    .slow_ios_i2c0_out_sda_out_en(soc$slow_ios_i2c0_out_sda_out_en),
	    .slow_ios_i2c1_out_scl_out(soc$slow_ios_i2c1_out_scl_out),
	    .slow_ios_i2c1_out_i2c_DRV0(),
	    .slow_ios_i2c1_out_i2c_DRV1(),
	    .slow_ios_i2c1_out_i2c_DRV2(),
	    .slow_ios_i2c1_out_i2c_PD(),
	    .slow_ios_i2c1_out_i2c_PPEN(),
	    .slow_ios_i2c1_out_i2c_PRG_SLEW(),
	    .slow_ios_i2c1_out_i2c_PUQ(),
	    .slow_ios_i2c1_out_i2c_PWRUPZHL(),
	    .slow_ios_i2c1_out_i2c_PWRUP_PULL_EN(),
	    .slow_ios_i2c1_out_scl_out_en(soc$slow_ios_i2c1_out_scl_out_en),
	    .slow_ios_i2c1_out_sda_out(soc$slow_ios_i2c1_out_sda_out),
	    .slow_ios_i2c1_out_sda_out_en(soc$slow_ios_i2c1_out_sda_out_en),
	    .slow_ios_qspi0_out_clk_o(soc$slow_ios_qspi0_out_clk_o),
	    .slow_ios_qspi0_out_io_o(soc$slow_ios_qspi0_out_io_o),
	    .slow_ios_qspi0_out_io0_sdio_ctrl(),
	    .slow_ios_qspi0_out_io1_sdio_ctrl(),
	    .slow_ios_qspi0_out_io2_sdio_ctrl(),
	    .slow_ios_qspi0_out_io3_sdio_ctrl(),
	    .slow_ios_qspi0_out_io_enable(soc$slow_ios_qspi0_out_io_enable),
	    .slow_ios_qspi0_out_ncs_o(soc$slow_ios_qspi0_out_ncs_o),
	    .slow_ios_qspi1_out_clk_o(soc$slow_ios_qspi1_out_clk_o),
	    .slow_ios_qspi1_out_io_o(soc$slow_ios_qspi1_out_io_o),
	    .slow_ios_qspi1_out_io0_sdio_ctrl(),
	    .slow_ios_qspi1_out_io1_sdio_ctrl(),
	    .slow_ios_qspi1_out_io2_sdio_ctrl(),
	    .slow_ios_qspi1_out_io3_sdio_ctrl(),
	    .slow_ios_qspi1_out_io_enable(soc$slow_ios_qspi1_out_io_enable),
	    .slow_ios_qspi1_out_ncs_o(soc$slow_ios_qspi1_out_ncs_o));
  ...
  // rule RL_send_sda_connect_i2c0
  assign CAN_FIRE_RL_send_sda_connect_i2c0 = 1'd1 ;
  assign WILL_FIRE_RL_send_sda_connect_i2c0 = 1'd1 ;

  // rule RL_connect_i2c0
  assign CAN_FIRE_RL_connect_i2c0 = 1'd1 ;
  assign WILL_FIRE_RL_connect_i2c0 = 1'd1 ;

  // rule RL_send_sda_connect_i2c1
  assign CAN_FIRE_RL_send_sda_connect_i2c1 = 1'd1 ;
  assign WILL_FIRE_RL_send_sda_connect_i2c1 = 1'd1 ;

  // rule RL_connect_i2c1
  assign CAN_FIRE_RL_connect_i2c1 = 1'd1 ;
  assign WILL_FIRE_RL_connect_i2c1 = 1'd1 ;

  // rule RL_connect_flash0_ports1
  assign CAN_FIRE_RL_connect_flash0_ports1 = 1'd1 ;
  assign WILL_FIRE_RL_connect_flash0_ports1 = 1'd1 ;

  // rule RL_connect_flash0_input_ports
  assign CAN_FIRE_RL_connect_flash0_input_ports = 1'd1 ;
  assign WILL_FIRE_RL_connect_flash0_input_ports = 1'd1 ;

  // rule RL_connect_flash1_ports1
  assign CAN_FIRE_RL_connect_flash1_ports1 = 1'd1 ;
  assign WILL_FIRE_RL_connect_flash1_ports1 = 1'd1 ;

  // rule RL_connect_flash1_input_ports
  assign CAN_FIRE_RL_connect_flash1_input_ports = 1'd1 ;
  assign WILL_FIRE_RL_connect_flash1_input_ports = 1'd1 ;
  ...
  // rule RL_connect_uart0_sout
  assign CAN_FIRE_RL_connect_uart0_sout = 1'd1 ;
  assign WILL_FIRE_RL_connect_uart0_sout = 1'd1 ;
  ...
  // register reg_dump
  assign reg_dump$D_IN = TASK_fopen___d178 ;
  ...
  assign uart_rRecvBitCount$D_IN =
	     uart_pwRecvResetBitCount$whas ? 4'd0 : x__h11651 ;
  assign uart_rRecvBitCount$EN =
	     uart_pwRecvResetBitCount$whas || uart_pwRecvEnableBitCount$whas ;

  // register uart_rRecvCellCount
  assign uart_rRecvCellCount$D_IN =
	     uart_pwRecvCellCountReset$whas ? 4'd0 : x__h10010 ;
  assign uart_rRecvCellCount$EN =
	     CAN_FIRE_RL_uart_baudGen_count_baudtick_16x ;

  // register uart_rRecvData
  assign uart_rRecvData$D_IN = soc$slow_ios_uart0_coe_modem_output_stx ;
  ...
  assign uart_rXmitCellCount$D_IN =
	     uart_pwXmitCellCountReset$whas ? 4'd0 : x__h13442 ;
  ...
  // register uart_rXmitParity
  assign uart_rXmitParity$D_IN = z__h14891 ^ uart_fifoXmit$D_OUT[7] ;
  ...
  // submodule flash0
  assign flash0$CSNeg = soc$slow_ios_qspi0_out_ncs_o ;
  assign flash0$SCK = soc$slow_ios_qspi0_out_clk_o ;

  // submodule flash1
  assign flash1$CSNeg = soc$slow_ios_qspi1_out_ncs_o ;
  assign flash1$SCK = soc$slow_ios_qspi1_out_clk_o ;

  // submodule i2c_bfm_slave0
  assign i2c_bfm_slave0$A0 = 1'b0 ;
  assign i2c_bfm_slave0$A1 = 1'b0 ;
  assign i2c_bfm_slave0$A2 = 1'b1 ;
  assign i2c_bfm_slave0$SCL = linescl0$O ;
  assign i2c_bfm_slave0$WP = 1'b0 ;

  // submodule i2c_bfm_slave1
  assign i2c_bfm_slave1$A0 = 1'b0 ;
  assign i2c_bfm_slave1$A1 = 1'b0 ;
  assign i2c_bfm_slave1$A2 = 1'b1 ;
  assign i2c_bfm_slave1$SCL = linescl1$O ;
  assign i2c_bfm_slave1$WP = 1'b0 ;

  // submodule soc
  assign soc$boot_sequence_bootseq = 1'b1 ;
  assign soc$slow_ios_gpio_in_inp = 32'd0 ;
  assign soc$slow_ios_i2c0_out_scl_in_in = line_SCL0$O ;
  assign soc$slow_ios_i2c0_out_sda_in_in = line_SDA0$O ;
  assign soc$slow_ios_i2c1_out_scl_in_in = line_SCL1$O ;
  assign soc$slow_ios_i2c1_out_sda_in_in = line_SDA1$O ;
  assign soc$slow_ios_qspi0_out_io_i_io_i =
	     { qspi0tri_sio3$O,
	       qspi0tri_sio2$O,
	       qspi0tri_sio1$O,
	       qspi0tri_sio0$O } ;
  assign soc$slow_ios_qspi1_out_io_i_io_i =
	     { qspi1tri_sio3$O,
	       qspi1tri_sio2$O,
	       qspi1tri_sio1$O,
	       qspi1tri_sio0$O } ;
  ...
  assign _dor2uart_pwXmitCellCountReset$EN_wset =
	     ...
	     WILL_FIRE_RL_uart_transmit_wait_1_bit_cell_time ||
	     WILL_FIRE_RL_uart_transmit_send_start_bit ;
  assign uart_baudGen_rBaudCounter_value__3_PLUS_1_0_ULT_5___d51 =
	     uart_baudGen_rBaudCounter$Q_OUT + 16'd1 < 16'd5 ;
  assign x__h10010 = uart_rRecvCellCount + 4'd1 ;
  assign x__h11651 = uart_rRecvBitCount + 4'd1 ;
  assign x__h13442 = uart_rXmitCellCount + 4'd1 ;
  assign x__h13468 = uart_rXmitBitCount + 4'd1 ;
  assign z__h14856 = uart_fifoXmit$D_OUT[0] ^ uart_fifoXmit$D_OUT[1] ;
  assign z__h14863 = z__h14856 ^ uart_fifoXmit$D_OUT[2] ;
  assign z__h14870 = z__h14863 ^ uart_fifoXmit$D_OUT[3] ;
  assign z__h14877 = z__h14870 ^ uart_fifoXmit$D_OUT[4] ;
  assign z__h14884 = z__h14877 ^ uart_fifoXmit$D_OUT[5] ;
  assign z__h14891 = z__h14884 ^ uart_fifoXmit$D_OUT[6] ;
  ...
  begin
	...
	begin
	  TASK_fopen___d178 = $fopen("app_log", "w");
	  #0;
	end
    if (uart_reset$OUT_RST != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_open_file && TASK_fopen___d178 == 32'd0)
	$finish(32'd0);
    if (uart_reset$OUT_RST != `BSV_RESET_VALUE)
